...
public class MagikEldritchYellow : MaterialTargetGenerator {
    public static List<FileTarget> GenerateTargets() {
        ...
        Func<float[], float[]> blueCyanToYellowMapper = rgb => ColorOps.NormalizeThenFunctionThenUnnormalize(
        ...
        for (int i = 1; i <= flowMax; i++) {
            ...
            if (i == 7 || i == 27 || i == 43) {
                ...
                fileTarget.AddVectorTarget(name => name == "BaseColor", _ => [2, 0, 0]);
                generalVectorModifyFunc = yellowMapper;
            } else {
                generalVectorModifyFunc = blueCyanToYellowMapper;
            }
        ...
        foreach (string endingNum in new string[] { "319", "320", "323", "324", "341", "342" }) {
            ...
            fileTarget.AddVectorTarget(colorTargeter, blueCyanToYellowMapper);
            fileTargets.Add(fileTarget);
        }
        ...
        foreach (string innerInnerPath in new string[] { "10290\\", "10290\\Lobby\\" }) {
            ...
            foreach (string fileName in new string[] { "Equip_04", "Equip_05", "Weapon_01", "Weapon_02" }) {
                ...
                if (fileName == "Equip_04" || fileName == "Equip_05") {
                    ...
                    fileTarget.AddScalarTarget(name => name == "cubeMapStrength", _ => 30);
                ...
                fileTarget.AddVectorTarget(colorTargeter, yellowMapper);
                fileTargets.Add(fileTarget);
            }
        }
