...
public class MagikEldritchPurple : MaterialTargetGenerator {
    public static List<FileTarget> GenerateTargets() {
        ...
        Func<float[], float[]> blueCyanToPurpleGradientMapper = rgb => ColorOps.NormalizeThenFunctionThenUnnormalize(
        ...
        Func<float[], float[]> purpleMapper = rgb => ColorOps.NormalizeThenFunctionThenUnnormalize(
            rgb, normalizedRGB => ColorOps.ModifyHSL(normalizedRGB,
                ModifyH: _hue => 260));
        ...
        for (int i = 1; i <= flowMax; i++) {
            ...
            if (i == 7 || i == 27 || i == 43) {
                ...
                generalVectorModifyFunc = purpleMapper;
            } else {
                generalVectorModifyFunc = blueCyanToPurpleGradientMapper;
            }
        ...
        foreach (string endingNum in new string[] { "319", "320", "323", "324", "341", "342" }) {
            ...
            fileTarget.AddVectorTarget(colorTargeter, blueCyanToPurpleGradientMapper);
            fileTargets.Add(fileTarget);
        }
        ...
        foreach (string innerInnerPath in new string[] { "10290\\", "10290\\Lobby\\" }) {
            ...
            foreach (string fileName in new string[] { "Equip_04", "Equip_05", "Weapon_01", "Weapon_02" }) {
                ...
                //}
                fileTarget.AddVectorTarget(colorTargeter, purpleMapper);
                fileTargets.Add(fileTarget);
            }
        }
